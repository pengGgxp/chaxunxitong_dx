...
class xuexiaoinfo(models.Model):
    ...
    banxuecengci = models.CharField(verbose_name='办学层次', choices=BANXUECENGCI_CHOICES, max_length=200,null=True, blank=True)
    BEIZHU_CHOICES = [
        ('公办', '公办'),
        ('民办', '民办'),
        ('中外合作办学', '中外合作办学'),
    ...
    beizhu = models.CharField(verbose_name='备注', max_length=200, choices=BEIZHU_CHOICES,null=True, blank=True,default='公办')
...
class zhaoshengxinxi(models.Model):
    xuexiaomingcheng = models.ForeignKey(xuexiaoinfo, on_delete=models.CASCADE, verbose_name='学校名称',null=True, blank=True)
    ...
    xingzhi = models.CharField(verbose_name='性质（专科/本科）', max_length=200, choices=XINGZHI_CHOICES,null=True, blank=True)
    ...
    kaoshifangshi = models.CharField(verbose_name='考试方式', max_length=200, choices=KAOSHIFANGSHI_CHOICES, default='线下',null=True, blank=True)
